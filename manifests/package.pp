...
class burp::package {
  ...
  $burp_requires = [ "make", "ncurses-dev", "build-essential", "g++", "libacl1-dev", "librsync-dev", "libz-dev", "libssl-dev", "uthash-dev", "libyajl-dev" ]
  ...
  if $::operatingsystem != 'Ubuntu' {
    ...
    exec { 'configure_burp':
      command => "/tmp/burp-${burp::version}/configure && /usr/bin/make && /usr/bin/make install",
